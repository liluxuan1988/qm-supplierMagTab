...
var _MaterialForm = require("./MaterialForm");

var _MaterialForm2 = _interopRequireDefault(_MaterialForm);

require("./index.less");

var _mirrorx = require("mirrorx");

var _FixedForm = require("../FixedPoint/FixedForm");
...
var MaterialGroup = function (_Component) {
    _inherits(MaterialGroup, _Component);
    ...
    function MaterialGroup(props) {
        ...
        _this.onLoadData = function () {
            ...
            _mirrorx.actions.supplierRouter.getSupplierPsGroupData(_extends({}, otherParam, param)); // 获取表格数据，如果传入的分页信息可以覆盖默认值
        };
    ...
    MaterialGroup.prototype.componentDidMount = function componentDidMount() {
        this.onLoadData({ supplierCode: this.props.supplierCode }); // 获取查询数据
    };

    MaterialGroup.prototype.render = function render() {
        ...
        return _react2["default"].createElement(
            ...
            _react2["default"].createElement(_MaterialForm2["default"], props)
        );
    };
