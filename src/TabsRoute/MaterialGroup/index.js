...
import FixedForm from "../FixedPoint/FixedForm";
...
class MaterialGroup extends Component {
    ...
    onLoadData = (param = {}) => {
        ...
        actions.supplierRouter.getSupplierPsGroupData({ ...otherParam, ...param});  // 获取表格数据，如果传入的分页信息可以覆盖默认值
    }
    render() {
  ...
  export default  connect(state => state. supplierRouter)(MaterialGroup)
